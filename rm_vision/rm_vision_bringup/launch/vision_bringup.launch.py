...
def generate_launch_description():
    ...
    def get_camera_armor_detector_container(camera_node):
    ...
    def get_camera_buff_detector_container(camera_node):
        return ComposableNodeContainer(
            name='camera_detector_container',
            namespace='',
            package='rclcpp_components',
    ...
    if (launch_params['camera'] == 'hik'):
        cam_armor_detector = get_camera_armor_detector_container(hik_camera_node)
        cam_buff_detector = get_camera_buff_detector_container(hik_camera_node)
    elif (launch_params['camera'] == 'mv'):
        cam_armor_detector = get_camera_armor_detector_container(mv_camera_node)
        cam_buff_detector = get_camera_buff_detector_container(mv_camera_node)
